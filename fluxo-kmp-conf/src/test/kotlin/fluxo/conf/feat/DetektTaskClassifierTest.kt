...
internal class DetektTaskClassifierTest {
    ...
    fun `platform source set tasks map to target families`() {
        ...
        assertTask("detektCompatibilityTest", DetectedTaskPlatform.JVM, main = false, test = true)
        ...
        assertTask("detektDebug", DetectedTaskPlatform.ANDROID, main = false)
        assertTask("detektRelease", DetectedTaskPlatform.ANDROID, main = false)
        assertTask("detektDebugUnitTest", DetectedTaskPlatform.ANDROID, main = false, test = true)
